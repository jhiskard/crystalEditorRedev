...
#define FONT_ICON_FILE_NAME_MSO "resources/icon/MaterialSymbolsOutlined.ttf"
#define FONT_ICON_FILE_NAME_MSR "resources/icon/MaterialSymbolsRounded.ttf"
#define FONT_ICON_FILE_NAME_MSS "resources/icon/MaterialSymbolsSharp.ttf"
